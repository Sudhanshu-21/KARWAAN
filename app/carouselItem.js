...
//   console.log("key " + key);
  ...
  return (
    <div
      className={` inline-flex items-center justify-center h-[490px] bg-white border-2 border-yellow-700`}
      
    >
      <div className=" max-w-full mx-[20%] h-[70%] border-4 border-blue-500 bg-[#B29B7E] grid grid-row-3 rounded-xl p-[4%] shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)] hover:shadow-[8.0px_16.0px_16.0px_rgba(0,0,0,0.48)]  overflow-hidden">
        {/* Event Photo  */}
